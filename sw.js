...
const CACHE = 'domo-shell-v55';
const ARQUIVOS = [
  './', './index.html', './styles.css', './config.js', './store.js', './ui.js',
  './pdf.js', './compras.js', './acervo.js', './cotacao.js', './cronograma.js', './qualificacao.js', './compromissos.js', './servicos.js', './rh.js', './permutas.js', './drive.js', './app.js?v=55',
